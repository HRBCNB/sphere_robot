...
/**
 * @brief 由point_set和start_end_derivative计算B-spline的控制点control points
 *
 * @param ts 离散化时间间隔
 * @param point_set 输入的离散轨迹点集
 * @param start_end_derivative 输入的起终点导数（速度和加速度）
 * @param ctrl_pts 输出的控制点矩阵，3 x N，每列是一个控制点
 * @return control points矩阵
 */
